...
export default class ApiService {
    ...
    static async getAllUser() {
        const response = await axios.get(`${this.BASE_URL}/auth/get-all`)
        return response.data;
    }
    ...
    static async getUserById(userId, token){
        try{
            const response = await axios.get(`${this.BASE_URL}/auth/admin/get-users/${userId}`, 
            {
    ...
    static async deleteUser(userId, token){
        try{
            const response = await axios.delete(`${this.BASE_URL}/auth/admin/delete/${userId}`, 
            {
                headers: {Authorization: `Bearer ${token}`}
            })
            return response.data;
    ...
    static async updateUser(userId, userData, token){
        try{
            const response = await axios.put(`${this.BASE_URL}/auth/admin/update/${userId}`, userData,
            {
                headers: {Authorization: `Bearer ${token}`}
            })
            return response.data;
