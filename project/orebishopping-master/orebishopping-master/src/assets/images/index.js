...
export {
  ...
  // imprimante pantum
  IMPRIMANTE_PANTUM_CP2200DW, IMPRIMANTE_PANTUM_M6559N, IMPRIMANTE_PANTUM_M6609N, IMPRIMANTE_PANTUM_P2509, IMPRIMANTE_PANTUM_P2509W, IMPRIMANTE_PANTUM_P3300DN,
  IMPRIMANTE_PANTUM_P3300DW, bac1,
  bac2,
  bac3,
  bac4, bannerImgOne, bannerImgThree, bannerImgTwo, bestSellerFour,
  // Best Sellers
  bestSellerOne, bestSellerThree, bestSellerTwo, emptyCart, encre1,
  encre2,
  encre3,
  encre4, espson1,
  espson2,
  ...
  imprimante7,
  imprimante8,
  imprimante9, logo, logo1, logoLight, newArrFour,
  // ===================== Products start here ============
  // New Arrivals
  newArrOne, newArrThree, newArrTwo,
  // ===================== Products End here ==============
  paymentCard, pdf1,
  // Year Product
  productOfTheYear,
  ...
  ruban2,
  ruban3,
  ruban4, saleImgOne, saleImgThree, saleImgTwo, spfFour,
  // Sprcial Offers
  spfOne, spfThree, spfTwo
};
